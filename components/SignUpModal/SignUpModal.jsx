...
const SignUpModal = ({ setIsSingUpOpen, isSingUpOpen }) => {
  ...
  return (
    <div
      className={`${
        isSingUpOpen ? 'relative' : 'hidden'
      } w-full h-[520px]  bg-black/30 backdrop-blur-lg z-50  mt-16 rounded-lg`}
    >
      <motion.div
        animate={{ scale: isSingUpOpen ? 1 : 0 }}
        className="grid grid-cols-1 lg:grid-cols-2 w-full h-full mx-auto overflow-hidden rounded-lg"
      >
        ...
        <div>
          <div className="card relative flex-shrink-0 w-full h-full shadow-2xl bg-[#1b2039] rounded-none">
            <h1 className="text-primary font-bold text-3xl text-center mt-5">
              Sign Up
            </h1>
            ...
            >
              <div className="form-control">
                ...
                <input
                  type="text"
                  placeholder="email"
                  className="input input-bordered bg-transparent border-white"
                  {...register('email', {
                    required: true,
                  })}
                />
            ...
            <motion.span
              onClick={() => setIsSingUpOpen(!isSingUpOpen)}
